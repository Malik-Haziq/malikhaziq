...
```bash
git clone https://github.com/Malik-Haziq/malikhaziq
cd malikhaziq
pnpm install
pnpm dev
```
...
- Website: https://malikhaziq.dev/
- X: [@MalikHaziq19](https://x.com/MalikHaziq19)
...
Copyright © 2026 [Malik Haziq](https://github.com/Malik-Haziq).<br />