...
This is Malik Haziq’s portfolio website, built using Next.js 15 to showcase real-world frontend engineering skills, high-performance UI, and production-level code quality.

The goal of this project is not just presentation—but conversion:
- Turn visitors into recruiters, clients, or collaborators
- Demonstrate technical depth, not just visuals

The design is minimal, black & white, with subtle accents to maintain focus and clarity.
...
- Showcase impactful projects (not basic clones)
- Highlight performance optimization skills
- Demonstrate clean architecture and scalability
- Build a strong personal brand as a frontend engineer
